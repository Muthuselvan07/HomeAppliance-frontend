  ...
  <div className="flex flex-col md:flex-row items-center md:items-start justify-center md:justify-between gap-6 md:gap-10 mt-6 w-full max-w-6xl">
    ...
    <div className="w-full md:w-1/2 flex flex-col justify-center text-left space-y-4 md:space-y-6 px-2 md:px-0">
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold">
          I Mitsubishi Electric MSY-GR18VFT-DA1 1.5 Ton 5 Star Inverter Split AC White
      </h2>
  ...
  <div className="space-y-6 text-gray-700">
    ...
    <div>
      <ul className="list-disc list-inside space-y-1">
        <li>Grooved Piping: This refers to pipes that have grooves on the inner surface, which increases the surface area for heat exchange, thereby improving the efficiency of cooling or heating in HVAC systems.</li>
        <li>
            Poki Poki Motor: This term likely refers to a highly efficient motor used in air conditioning systems. The "Poki Poki" design might indicate a unique manufacturing technique that enhances the motor's performance and durability.
        </li>
        <li>
          Inverter Technology: The GR Series features advanced inverters that utilize cutting edge technology, developed worldwide through many years of experience. We have achieved powerful cooling with high energy efficiency, to bring you optimal comfort.
        </li>
        <li>
          Powerful Cool: This denotes the unit's capability to provide a strong and efficient cooling performance, which is especially useful in extremely hot climates or large spaces that require robust cooling power.
        </li>
      </ul>
    </div>
