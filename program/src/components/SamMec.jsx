  ...
  <div className="space-y-6 text-gray-700">
    ...
    <div>
      ...
      <ul className="list-disc list-inside space-y-1">
        <li>
         Fully-automatic top load washing machine with Ecobubble wash technology: Affordable with great wash quality, Easy to use
        </li>
        <li>
         Capacity 8 kg: Suitable for large families | Water Pressure: 
        <li>0.01-0.78 Mpa(01-8.0kg.f/cm²) | Water Consumption : Refer to BEE label
          </li>
          Manufacturer Warranty: 2 Years comprehensive on product, 20 Years on Digital Inverter (Note: Brand Warranty can be availed using seller invoice)
         </li>
        <li>
         Wash Programs: 6 Wash Programs – Bedding | Delicates| Eco Tub Clean| Energy Saving| Additional Cycle : Normal, Quick Wash, Jeans

        </li>
      </ul>
      <li>
        Interior Description : Fresh Food Capacity : 183 Ltr | Freezer Capacity : 53 Ltr | Total no. of compartments : 2 | Shelves : 2 | Vegetable Drawers : 1 | Shelf Type : Toughened Glass Shelves | Anti Bacterial Gasket | Temperature Control : External
      </li>
    </div>
