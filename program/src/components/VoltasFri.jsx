  ...
  <div className="space-y-6 text-gray-700">
    ...
    <div>
      ...
      <ul className="list-disc list-inside space-y-1">
        <li>
          Side by Side Frost-Free Refrigerators: Premium Refrigerator with auto-defrost function to prevent ice build-up
        </li>
        <li>
          Storage or Interior Description : Fresh food capacity: 344 ltrs, Frezzer Capacity: 177 ltrs, Number of Compartments: 2, Drawers: 4, Shelves: 8, Shelf type : Spill proff adjustable toughened glass shelves, Anti bacterial gasket, 2 ltrs bottle storage, Dual twist Ice tray, Dual LED Illumination.
        </li>
        <li>
          Special Features : Electronic Temprature Control and Display, Stabilizer free Operation, Multi Air flow.
        </li>
        <li>
          Energy savings with ProSmart Inverter Compressor
        </li>
      </ul>
    </div>
