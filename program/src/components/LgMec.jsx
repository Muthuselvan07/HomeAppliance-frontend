  ...
  <div className="flex flex-col md:flex-row items-center md:items-start justify-center md:justify-between gap-6 md:gap-10 mt-6 w-full max-w-6xl">
    ...
    <div className="w-full md:w-1/2 flex justify-center md:justify-start">
      <img
        ...
        className="max-w-full md:max-w-[50%] h-auto rounded-lg shadow-lg"
      />
    </div>
  ...
  <div className="space-y-6 text-gray-700">
    ...
    <div>
      ...
      <ul className="list-disc list-inside space-y-1">
        <li>
         LG Fully-Automatic Front Load Washing Machine with Hygiene Steam/ Inverter Direct Drive Technology: Best Wash Quality, Energy and Water efficient
        </li>
        <li>
           Energy Rating: 5 Star- Best in class efficiency | Inverter direct drive technology for energy savings, less vibration & less noise | Energy consumption – 0.06 KWh/kg/cycle
          </li>
        <li>
          Drum / Pulsator type and Drum size| Body: Rust- resistant stainless steel Inner Drum and Door Type- Black Tempered Glass; Drum Lifter: Plastic | Motor material & type: The Direct Drive motor is attached directly to the washing tub without a belt or pulley | Control Panel Information: Power On/Off Button; Programme Knob; Start/Pause Button; Extra Options and Functions; Customizing Washing Programme Buttons; Display; Estimated Time Remaining; Rinse+; Pre Wash; Delay End
        </li>
        <li>
          Additional Features: Protective Rat Mesh; Soft closing door; Digital Timer and Custom end of cycle notification or alarm; Powder or liquid detergent and conditioner dispenser from tray; 6 Motion Direct Drive; Inverter DirectDrive; Plastic Drum Lifter; Smart Diagnosis; Child Lock
       </li>
      </ul>
