  ...
  <div className="space-y-6 text-gray-700">
    ...
    <div>
      ...
      <ul className="list-disc list-inside space-y-1">
        ...
        <li>
          Manufacturer Warranty : The product comes with a 1 year comprehensive warranty and a 20 years warranty on the digital inverter compressor. (Note: Brand Warranty can be availed using seller invoice)
          </li>
