...
function HaierFri() {
  ...
  <div className="space-y-6 text-gray-700">
    ...
    <div>
      ...
      <li>
        Frost Free Refrigerator: Premium auto defrost with powerful cooling and long lasting freshness and performance.
      </li>
      <li>
        Capacity: 240 Litres Double Door Fridge; This refrigerator is suitable for families with 3 to 4 members | Freezer capacity: 57 Ltr, Fresh food capacity: 183 Ltr.
      </li>
      <li>
        Interior Description: Double Door Refrigerator with Fresh Food Capacity : 183L | Freezer Capacity : 57L | Total No Of Compartments : 1 | Vegetable Drawers : 1 | Shelves : 3 | Shelf Type : Toughened Glass Shelves | Anti-Bacterial Gasket.
      </li>
       </ul>
    </div>
