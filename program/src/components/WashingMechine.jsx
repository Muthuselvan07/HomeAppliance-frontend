...
import w2 from '/assets/wmec.webp'
import w3 from '/assets/washing.webp'
import w4 from '/assets/w3.webp'

import { useState } from "react";

function WashingMechine(){
    ...
    return(
        <>
         <div className="md:hidden bg-blue-800 text-white flex items-center justify-between p-4">
                <h1 className="text-2xl font-bold text-center">WASHING MECHINE</h1>
                <button
     ...
     <div className="flex-1 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 justify-center mt-14">
            <div className=" flex flex-col items-center justify-between text-center relative  bg-white px-2 py-1 rounded-lg shadow  hover:shadow-2xl shadow-black hover:translate-y-5 hover:scale-105 transition-transform duration-300">
                <img src={w1}  className="w-[250px] h-[180px] object-contain mx-auto "/>
              ...
              >
                ...
                <h3>price:3500</h3>
                <button className="bg-blue-800 w-[100px] h-[50px] text-white rounded-2xl p-3 mb-5 cursor-pointer" onClick={()=>navigate("/appliance/washingmechine/samsung")}>view more</button>
            </div>
        ...
        <div className=" flex flex-col items-center text-center relative  bg-white px-2 py-1 rounded-lg shadow  hover:shadow-2xl shadow-black hover:translate-y-5 hover:scale-105 transition-transform duration-300">
                <img src={w2}  className="w-[250px] h-[180px] object-contain mx-auto "/>
              ...
              >
                ...
                <button className="bg-blue-800 w-[100px] h-[50px] text-white rounded-2xl p-3 mb-5 cursor-pointer" onClick={()=>navigate("/appliance/washingmechine/lg")}>view more</button>
              
            </div>
            <div className=" flex flex-col items-center text-center relative  bg-white px-2 py-1 rounded-lg shadow  hover:shadow-2xl shadow-black hover:translate-y-5 hover:scale-105 transition-transform duration-300">
                <img src={w3}  className="w-[250px] h-[180px] object-contain mx-auto"/>
              ...
              >
                ...
                <h3>price:3500</h3>
                <button className="bg-blue-800 w-[100px] h-[50px] text-white rounded-2xl p-3 cursor-pointer" onClick={()=>navigate("/appliance/washingmechine/whirlpool")}>view more</button>
            </div>
            <div className=" flex flex-col items-center text-center relative  bg-white px-2 py-1 rounded-lg shadow  hover:shadow-2xl shadow-black hover:translate-y-5 hover:scale-105 transition-transform duration-300">
                <img src={w4}  className="w-[250px] h-[180px] object-contain mx-auto"/>
              ...
              >
                ...
                <h3>price:3500</h3>
                <button className="bg-blue-800 w-[100px] h-[50px] text-white rounded-2xl p-3 cursor-pointer" onClick={()=>navigate("/appliance/washingmechine/haier")}>view more</button>
