...
import wash from '/assets/haierwashing.jpg'
...
function HaierMec() {
  ...
  <div className="flex flex-col md:flex-row items-center md:items-start justify-center md:justify-between gap-6 md:gap-10 mt-6 w-full max-w-6xl">
    ...
    <div className="w-full md:w-1/2 flex flex-col justify-center text-left space-y-4 md:space-y-6 px-2 md:px-0">
      ...
      Haier 8 Kg 5 Star Fully Automatic Top Load Washing Machine with Oceanus Wave Drum, Magic Filter, 8 Wash Programs (ETL80-AES5, Brown Grey, Stainless Steel Drum, 15 Mins Quick Wash)
      </h2>
  ...
  <div className="space-y-6 text-gray-700">
    ...
    <div>
      ...
      <ul className="list-disc list-inside space-y-1">
        <li>
         Fully-automatic Top load washing machine with Oceanus Wave Drum and Near Zero Pressure
        </li>
        <li>
           Energy Rating 5 Star : Best in class efficiency | Energy consumption – 0.0093* KWh/kg/cycle & Water Consumption: 17.26L/Kg/Cycle (Please refer BEE label for more information)
          </li>
        <li>
         Wash Programs: 8 No.of Programs - 8 Wash programs:- 8 Wash programs:- wash/Rinse/Spin/Tub Dry/Smart/Soak/Delicate/Quick
          </li>
...
<div>
  <img src={wash} alt="Washing Machine" className="w-full h-auto mt-10"/> 
</div>
</div>
